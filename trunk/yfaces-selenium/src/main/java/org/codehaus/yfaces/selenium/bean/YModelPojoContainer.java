package org.codehaus.yfaces.selenium.bean;
...
public class YModelPojoContainer {
	...
	private TestComponent testComponent5 = null;

	public YModelPojoContainer() {
		...
		this.testComponent5 = new TestComponent();
	}
	...
	public TestComponent getTestComponent5() {
